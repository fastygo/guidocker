...
import (
	...
	"gui-docker/domain"
	"gui-docker/handlers"
	"gui-docker/infrastructure"
	boltrepo "gui-docker/infrastructure/bolt"
	dockerrepo "gui-docker/infrastructure/docker"
	gitrepo "gui-docker/infrastructure/git"
	"gui-docker/infrastructure/hosting"
	"gui-docker/middleware"
	appusecase "gui-docker/usecase/app"
	scanusecase "gui-docker/usecase/scanner"
	settingsusecase "gui-docker/usecase/settings"
	"gui-docker/views"
	"log"
	"net"
	"net/http"
...
func buildServer(
	...
	handler := handlers.NewDashboardHandler(useCase, renderer)
